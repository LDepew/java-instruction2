...
public class Request {
	...
	public Request(int inId, int inUserID, String inDescription, String inJustification, LocalDate inLD,
			String inDlvMode, int inStatusID, double inTotal, LocalDateTime inSubmittedDate) {
		id = inId;
		userID = inUserID;
